...
## Introducción
La organización y etiquetado preciso de los datos es fundamental para una correcta interpretación y análisis de las señales biomédicas. En particular, en el caso de la adquisición de datos ECG a través de un sensor Bitalino, la tabulación de los datos permitirá una visualización y análisis más ordenado y preciso de las señales eléctricas del corazón. Además, una tabulación precisa facilitará la aplicación de técnicas de aprendizaje automático en el futuro para detectar patrones en el diagnóstico de enfermedades cardíacas. En este laboratorio, se busca comprender la importancia de la organización y etiquetado de los datos de sensores biomédicos para su aplicación en la investigación, utilizando un cuaderno de Jupyter para la codificación necesaria para organizar y tabular los datos.
